...
class BudgetCheckService : Service() {
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        // Only try to start as foreground if we were started with startForegroundService()
    ...
    private fun scheduleDailyReminder() {
        ...
        // Parse reminder time
        val timeString = prefsManager.getReminderTime() // Format "HH:mm"
        ...
        try {
            ...
            try {
                ...
                // Fallback to less exact alarm if exact timing fails
                alarmManager.set(
                    AlarmManager.RTC_WAKEUP,
                    calendar.timeInMillis,
                    pendingIntent
            ...
            // Fallback: schedule reminder for 8pm today or tomorrow
            val calendar = Calendar.getInstance().apply {
